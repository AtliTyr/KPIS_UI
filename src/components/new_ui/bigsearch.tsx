...
export const BigSearch: React.FC<SearchProps> = ({
    value = '',
    onChange,
    ...
    return (
        <div
            ...
            // `}
            className={
                cn('relative flex items-center gap-2 w-full max-w-sm pl-2 pr-1 py-2 rounded-[8px] border transition-colors duration-150',
                    'bg-[var(--color-some-els)] border-[var(--color-some-els)]',
                    isFocused ? 'ring-3 ring-[var(--color-outline)]' : '',
                    className
                )
